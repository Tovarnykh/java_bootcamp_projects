...
public class GameExecutor {
	 ...
	 * 
	 *                               Inside the function: 1. Returns data from
	 *                               TEAMS_FILE as a String[][] array
	 */
	 ...
	 * 
	 * Inside the function: 1. Grabs each play from plays.txt and calls
	 * game.simulate(play); 2. Prints the return from game.simulate(play) -
	 * println("\n" + <return> + "\n");
	 */
	 ...
	 * 
	 * Inside the function: 1. Prints the final score: println("\nGRYFFINDOR: " +
	 * <gryffindor score> + " SLYTHERIN: " + <slytherin score>); 2. Prints the
	 ...
	 * @param sec
	 * 
	 *            Inside the function: 1. Make the code sleep for X seconds.
	 */
